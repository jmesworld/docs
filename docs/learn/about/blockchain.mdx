...
<Admonition type="info" icon="☢️" title="Initial Distribution Period">

Note that in the first 28 days of launch, zero stake is required to help bootstrap the network via the [Initial Distribution Period](whitepaper.mdx#24-initial-distribution-period)
