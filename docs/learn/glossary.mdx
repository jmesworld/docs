...
A computer connected to the [JMES mainnet](#jmes-mainnet) that is able to validate transactions and interact with the JMES blockchain. All active [validators](#validator) run full nodes.
...
The latest version of the [JMES mainnet](#jmes-mainnet). 
