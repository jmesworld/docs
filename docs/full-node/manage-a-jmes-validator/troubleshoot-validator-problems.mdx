...
- The validator is not in the [active validator set](../../learn/glossary.mdx#active-set). Only the top 100 validators are in this set. To fix this problem, increase your total stake to be larger than the 100 validator.