...
1. Initialize your genesis file that will bootstrap the network. Replace the following variables with your own information:
   ...
   ```bash
     jmesd init --chain-id=<network-id> <node-moniker>
   ```
...
```bash
jmesd genesis add-genesis-account $(jmesd keys show <account-name> -a) 20000000000000ujmes
jmesd genesis gentx <my-account> 100000000ujmes --chain-id=<network-id>
...
| :---------- | :------ | :------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------- | 
| `jmes-namito`   | Testnet | [Genesis Link](https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-namito/genesis.json) |  Peer List Community maintained by [JMES](https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-namito/addrbook.json) |
| `jmes-picasso`   | Testnet | [Genesis Link](https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-picasso/genesis.json) |  Peer List Community maintained by [JMES](https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-picasso/addrbook.json) |
...
```bash
# Obtain the genesis for jmes-namito:
wget https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-namito/genesis.json -O ~/.jmes/config/genesis.json

# Obtain the addressbook for the jmes-picasso:
wget https://raw.githubusercontent.com/jmesworld/testnet/main/jmes-picasso/addrbook.json -O ~/.jmes/config/addrbook.json
```
